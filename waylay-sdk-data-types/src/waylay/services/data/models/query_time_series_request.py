...
from ..models.series_query_item import SeriesQueryItem
...
QueryTimeSeriesRequest: TypeAlias = SeriesQueryRequest | SeriesQueryWithoutAggregatesRequest | list[SeriesQueryItem]

...
class SeriesApi(WithApiClient):
    ...
    async def delete_series(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> MessageSuccessResult | T | Response | Model:
        """Delete Series.
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": MessageSuccessResult if not select_path else Model,
            }
        )
    ...
    async def get_series(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> list[MetricSummary] | T | Response | Model:
        """Get Series Overview.
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": list[MetricSummary] if not select_path else Model,
            }
        )
        non_200_response_types_map: dict[str, Any] = {}
        response_types_map.update(non_200_response_types_map)
    ...
    async def query_time_series(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> TimeseriesQueryResponse | T | Response | Model:
        """Query Series Data.
        ...
        if json is not None and validate_request:
            _BodyType = QueryTimeSeriesRequest  # fmt: skip  # noqa: UP045
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": TimeseriesQueryResponse if not select_path else Model,
            }
        )
        non_200_response_types_map: dict[str, Any] = {
            "400": ErrorResponse,

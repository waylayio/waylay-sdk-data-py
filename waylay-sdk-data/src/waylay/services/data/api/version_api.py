...
if TYPE_CHECKING:
    ...
    from waylay.services.data.queries.version_api import HealthQuery
...
class VersionApi(WithApiClient):
    ...
    async def health(
        self,
        *,
        query: HealthQuery | QueryParamTypes | None = None,
    ...
    async def health(
        ...
        **kwargs,
        ...
        :type query: HealthQuery | QueryParamTypes, optional
        ...
        if query is not None and should_validate:
            query = TypeAdapter(HealthQuery).validate_python(query)

...
class EventsApi(WithApiClient):
    ...
    async def post_series(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = Optional[PostSeriesRequest]  # fmt: skip  # noqa: UP045
    ...
    async def post_series_for_resource(
        ...
        **kwargs,
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = Optional[PostSeriesForResourceRequest]  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
    ...
    async def stream_events(
        ...
        *,
        ...
        timeout=STREAM_TIMEOUTS,
        **kwargs,
    ) -> AsyncIterator[TimestampedResourceEvent] | AsyncIterator[T] | Response | AsyncIterator[Model]:
